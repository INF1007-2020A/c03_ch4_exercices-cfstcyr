...
def replace_char(string: str, old_char: str, new_char: str) -> str:
    ...
    return string[:index] + new_char + string[index + len(old_char):]
...
def main() -> None:
    ...
    string = "hello world!"
    print(f"On remplace le caratère w par le caractère z dans la chaine: '{string}'. Résultat: {replace_char(string, 'R', 'z')}")
